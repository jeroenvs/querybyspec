...
/**
 * Provides construction logic for {@link SpecificationTranslator} instances.
...
public interface SpecificationTranslatorFactory {
     ...
     */
    SpecificationTranslator forDefaultConverters();
     ...
     */
    SpecificationTranslator forAnnotatedConverters(String basePackage);
